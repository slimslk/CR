...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        /*for (int i=0; i<25; i++){
            ...
            String pl_name = playerJDBCTemplate.getNickname((int)(Math.random()*24)+1);
            ...
            if (checkID != null) {
                playerJDBCTemplate.update(pl_id, pl_name, pl_distance, pl_clones, pl_time, pl_score);
            } else {
                playerJDBCTemplate.create(pl_id, pl_name, pl_distance, pl_clones, pl_time, pl_score);
            }
